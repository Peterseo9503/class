...
const obj: object = {};
let list1: any[] = [1,"ff",true];
let list2: number[] = [1,3,4,5,6];
let list3: Array<number> = [12,3,4];
...
const elem : HTMLElement | null = document.getElementById("test");
class Person {};
...
const $input3: HTMLElement | null = document.querySelector('input["type="text"]');
